export default function DayColumn(props) {
  return (
    <div className=" w-60 p-4 rounded-2xl flex flex-col m-3 gap-2">
      <h1 className="p-3 rounded-xl text-2xl font-bold w-full text-center">{props.day}
        </h1>
      ...
      <button onClick={() => props.handleOpen(props.day)} className="bg-warm-button border border-gray-300 p-3 rounded-xl">+ Add meal</button>
    </div>
  );
}
